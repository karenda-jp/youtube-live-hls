...
※製品版では視聴者数の最も多い番組を特定表示しています<br/>
英語圏ローカル以外へ設置した場合「Sign in to confirm you’re not a bot.」と警告されて動作しません。<br/>
※エラー的には404表示となり使用者の外見上は判断できませんが、、、<br/>
ローカルであっても、シークレットウインドウでアクセスした際に毎回ログイン警告が出る方は動作しません。<br/>
日本語では「ログインしてbotではないことを確認してください」の事です。<br/>
個人のIP-BAN具合は当方と関係ありません。<br/>
